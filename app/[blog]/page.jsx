...
async function page({params: {blog}}) {
  ...
  return (
    <div className='mt-24'>
        ...
        <Link href="/"><div className='cursor-pointer hover:scale-105 duration-150 hover:rotate-1 bg-[#ff3471] w-[85vw] mx-auto text-white font-semibold px-4 py-2 lg:w-[60vw] xl:w-[45vw]'>previous page</div></Link>
    </div>
  )
}
