...
function page() {
  return (
    <div>
      ...
      <p className='text-lg pt-6 md:w-[45rem] mx-auto'>For pricing and more detailed info about our different services, please contact us by clicking this link <Link className='text-[#ff3471]' href={'/#'} onClick={() => window.location.href="/#contact"}>here.</Link></p>
